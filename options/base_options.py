...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # Add these arguments to base_options.py under dataset parameters
        parser.add_argument('--blur_dir', type=str, default='', help='path to unknown blurry images (trainA equivalent)')
        parser.add_argument('--sharp_dir', type=str, default='', help='path to sharp images (trainB equivalent)')
        parser.add_argument('--known_blur_dir', type=str, default='', help='path to known blurry images (trainC equivalent)')
        parser.add_argument('--known_sharp_dir', type=str, default='', help='path to sharp counterparts of known blur (trainD equivalent)')
